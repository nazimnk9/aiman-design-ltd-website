...
export default function About() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-white py-20 md:py-32 overflow-visible">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row lg:flex-row items-stretch lg:gap-0 relative z-30">
            {/* Left side - Image container with overlap effect */}
            <div className="w-full lg:w-1/2 animate-fadeInLeft relative">
              <div className="rounded-lg p-8 flex items-center justify-center min-h-96 h-full lg:pr-0 md:-mt-2 lg:mt-10">
