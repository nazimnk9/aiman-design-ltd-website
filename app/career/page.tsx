...
export default function Career() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Job Listings - Added 3D background animation */}
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 overflow-hidden">
        {/* <Background3D type="team" /> */}
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[200px]">
          <h2 className="text-3xl md:text-5xl font-bold text-foreground text-center animate-fadeInUp mb-6">
            Open Positions
          </h2>
          <div className="animate-fadeInUp delay-100 p-8 rounded-2xl bg-secondary/30 backdrop-blur-sm">
            <p className="text-xl md:text-3xl font-semibold text-muted-foreground text-center">
              Currently no hiring process is active
            </p>
          </div>
        </div>
      </section>
